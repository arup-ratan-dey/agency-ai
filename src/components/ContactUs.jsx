...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "d4eba069-da74-4ac5-8550-bbb8141e0e9b");
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        digital solutions that move your business forwards.'/>
        ...
        onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div>
             ...
             <div className='sm:col-span-2'>
               ...
               p-3 text-sm outline-none rounded-lg border border-gray-300' required></textarea>
            </div>
